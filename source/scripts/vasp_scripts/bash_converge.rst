...
This page contains a bash script to supervise the convergence of force in VASP calculation.
Fixed atoms are not considered here.

.. include ../../warnings/gnuplot.txt
